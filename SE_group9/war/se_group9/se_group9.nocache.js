...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "se_group9" because\n';
  ...
  $wnd.__gwt_activeModules['se_group9'] = {
    'moduleName' : 'se_group9',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/se_group9.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['se_group9'].superdevmode = true;

  var expectedSuffix = '/se_group9.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + se_group9 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:se_group9';
  var devModeSessionKey = '__gwtDevModeSession:se_group9';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':55313';
  var nocacheUrl = serverUrl + '/se_group9/se_group9.nocache.js';
  ...
  $wnd.__gwt_activeModules['se_group9'].canRedirect = true;
  $wnd.__gwt_activeModules['se_group9'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/se_group9?user.agent=' + ua + '&_callback=' + callback;
